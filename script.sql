...
CREATE DATABASE DB_RAYCKGONCALVES;

USE DB_RAYCKGONCALVES;
...
-- -----------------------------------------------------
-- Table TB_NUMERO DE CHASSI
-- -----------------------------------------------------
CREATE TABLE TB_NUMERO DE CHASSI (
  CLI_CODIGO INT UNSIGNED NOT NULL AUTO_INCREMENT,
  CLI_NOME VARCHAR(80) NOT NULL,
  CLI_BAI_CODIGO INT UNSIGNED NOT NULL,
  PRIMARY KEY (CLI_CODIGO),
  FOREIGN KEY (CLI_CHASSI_CODIGO) REFERENCES TB_CHASSI (CHASSI_CODIGO)
) ENGINE = InnoDB;
...
ALTER TABLE TB_ANO ADD CONSTRAINT CON_ANO_UNIQUE UNIQUE (ANO_ANO);
...
SELECT CAR_CODIGO, CAR_MODELO, CAR_ALUGUEL, CAR_KM, CAR_DISPONIVEL, ANO_ANO, MAR_MARCA, EST_ESTADO
FROM TB_CARROS
INNER JOIN TB_ANO ON CAR_ANO_CODIGO = ANO_CODIGO
